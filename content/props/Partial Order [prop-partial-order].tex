...
\begin{proposition}[prop-partial-order]
\[
...
\left(
\left( \TerForall a \in S \quad (a, a) \in R \right) \TermConjunction
\left( \TerForall a, b \in S \quad ((a, b) \in R \TermConjunction (b, a) \in R) \TermImplication a = b \right) \TermConjunction
\left( \TerForall a, b, c \in S \quad ((a, b) \in R \TermConjunction (b, c) \in R) \TermImplication (a, c) \in R \right)
\right)
\right)
\]
\end{proposition}
